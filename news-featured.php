		...
		<div class="contentWrap">
			<div class="pagePanel clear">
				...
				<div class="categoryList">
					...
					<ul>
						<li class="current"><a data-event-category="event-all" href="#">All</a></li>
						<li><a data-event-category="event-lecture" href="#">lecture</a></li>
						<li><a data-event-category="event-training" href="#">training</a></li>
						<li><a data-event-category="event-outdoor" href="#">outdoor</a></li>
					</ul>
				</div>
			</div>
			<div class="eventsWrap">
				...
				<div class="eventItem event-outdoor clear">
					<a href="single-event.html" class="eventItemImg">
						<img src="images/content/eventsItem4.jpg" alt="">
					</a>
					<div class="eventItemDesc">
						<time class="eventItemTime" datetime="2015-02-01">February 1, 2015 12:00 PM</time>
